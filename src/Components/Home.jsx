            ...
            <section className="Education">
                <div className="education-content">
                    <div className="education-text">
                        ...
                        <p>
                            <strong>Relevant Coursework:</strong> Intro to Cryptology, Info and Database Sys 1, Software Engineering, Operating 
Systems, Intro to Machine Learning, Data Structures and Algorithms
                        </p>
                        <p>
                            <strong>Involvement:</strong> Society of Software Developers, Gator AI, Society of Hispanic Professional Engineers
                        </p>
                        <p>
                            <strong>Honors:</strong> Dean's List (Fall 2022, Summer 2023, Spring 2024, Fall 2024, Spring 2025) | HSF Scholar & HSF Scholarship Receiver 
                        </p>
                    </div>
